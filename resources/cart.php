...
$product = <<<DELIMETER
    <tr> 
        ...
        <td>{$value}</td>
        <td>{$sub}</td>
        <td><a href="../resources/cart.php?remove={$row['product_id']}" class='btn btn-warning'><span class='glyphicon glyphicon-minus'></span></a> 
        <a href="../resources/cart.php?add={$row['product_id']}" class='btn btn-success'><span class='glyphicon glyphicon-plus'></span></a>
        <a href="../resources/cart.php?delete={$row['product_id']}" class='btn btn-danger'><span class='glyphicon glyphicon-remove'></span></a></td>
    </tr>
